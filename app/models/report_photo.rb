class ReportPhoto < ActiveRecord::Base
  ...
  has_attached_file :image, :styles => {:small => "150x150#", :large => "700x700>", :thumbnail => "60x60#", :middle => "360x345>"},
                    :url  => "/system/assets/user/report_photos/images/:id_partition/:style_:id.:extension",
                    :path => ":rails_root/public/system/assets/user/report_photos/images/:id_partition/:style_:id.:extension"
