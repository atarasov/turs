...
(function($, undefined) {
    ...
    $.widget("ui.slider", $.ui.mouse, {widgetEventPrefix:"slide",options:{animate:false,distance:0,max:100,min:0,orientation:"horizontal",range:false,step:1,value:0,values:null},_create:function() {
                var self = this,o = this.options,existingHandles = this.element.find(".ui-slider-handle").addClass("ui-state-default ui-corner-all"),handle = "<a class='ui-slider-handle ui-state-default  ' href='#'></a>",handleCount = (o.values && o.values.length) || 1,handles = [];
                ...
                handles.push(handle);
/*Собственная модификация скрипта здесь можно поменять параметры отображения стрелок слайдера*/
                    handles[0] ='<a class="ui-slider-handle  ui-state-default  ui-slider-r" href="#"></a>';
